...
# a) Games with global sales over 25 million
...
# c) Total NA sales vs total Japan sales
total_na_sales = 0
total_jp_sales = 0
for game in video_game_sales:
...
print(f"Total North America sales: {total_na_sales:.2f} million")
print(f"Total Japan sales: {total_jp_sales:.2f} million")
