...
# a) Extract just the names into a new list
game_names = []
...
print(dataset_info)
# A tuple is more appropriate here than a list because this metadata
# (game count, column count, dataset name) is fixed/descriptive info that
# shouldn't be accidentally modified after it's created -- tuples are
# immutable, so they protect these values from being changed by mistake,
# unlike a list.
